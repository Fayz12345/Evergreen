...
const Auth = () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (rememberMe) {
          ...
          Cookies.set('skipCaptcha', true, { expires: 5 });
        } else {
  ...
  return (
    ...
    <section className="slider text-white bg-dark py-5 mt-5">
        <Container>
            <Row className="justify-content-center text-center mt-5">
                <Col lg={9} md={12}>
                    <Fade top>
                        <h1 className="animated fadeInUp mb-3 mt-5 text-white">Login</h1>
    ...
    <div className="container-xl mt-5 bg-light p-2 text-dark bg-opacity-25">
