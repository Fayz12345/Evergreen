...
const TradeinForm = () => {
  ...
  <div className="text-center">
    <h2 className="display-5 fw-bold mb-4">Upgrade to the Latest and Save Big!</h2>
  ...
  <div className="text-center mt-5">
    ...
    <Button variant="primary" size="lg" className="me-2" onClick={handleCheckPriceModalShow}>Check Price</Button>
                  
    <Button variant="secondary" size="lg"  onClick={handlePrepareModalShow}>Prepare Your Phone</Button>
 ...
 <Modal show={showPrepareModal} onHide={handlePrepareModalClose}  size="xl"  dialogClassName="modal-dialog-centered">
                ...
                <Modal.Footer>
                    <Button variant="primary" onClick={handlePrepareModalClose}>Close</Button>
                </Modal.Footer>
            </Modal>


      <Modal show={showCheckPriceModal} onHide={handleCheckPriceModalClose} size="xl"  dialogClassName="modal-dialog-centered">
                <Modal.Header closeButton>
